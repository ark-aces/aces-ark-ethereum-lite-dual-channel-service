package com.arkaces.ark_ethereum_lite_dual_channel_service.ark_ethereum_channel.service_info;
...
public class ServerInfoController {
    ...
    @Value("${arkEthereumChannel.urlPrefix}")
