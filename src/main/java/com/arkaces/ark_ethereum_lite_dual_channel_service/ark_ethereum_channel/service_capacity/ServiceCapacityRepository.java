...
@Repository("arkEthereumChannel.serviceCapacityRepository")
public interface ServiceCapacityRepository extends JpaRepository<ServiceCapacityEntity, Long> {

    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("select s from com.arkaces.ark_ethereum_lite_dual_channel_service.ark_ethereum_channel.service_capacity.ServiceCapacityEntity s where s.pid = :pid")
