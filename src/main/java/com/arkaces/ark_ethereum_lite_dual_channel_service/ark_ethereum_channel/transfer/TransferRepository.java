...
@Repository("arkEthereumChannel.transferRepository")
public interface TransferRepository extends JpaRepository<TransferEntity, Long> {
    ...
    @Query("select t from com.arkaces.ark_ethereum_lite_dual_channel_service.ark_ethereum_channel.transfer.TransferEntity t where t.pid = :pid")
